...
gate_in_type = {
    ...
    'DFFRS_X2_Q': 'D1RN1KN1CK1',
    'DFFRS_X2_QN': 'D1RN1KN1CK1',
    'DFFR_X1_Q': 'D1RN1CK1',
    'DFFR_X1_QN': 'D1RN1CK1',
    'DFFR_X2_Q': 'D1RN1CK1',
    'DFFR_X2_QN': 'D1RN1CK1',
    ...
    'OR4_X2_ZN': 'A4',
    'OR4_X4_ZN': 'A4',
    'SDFFRS_X1_Q': 'D1RN1KE1KL1KN1CK1',
    'SDFFRS_X1_QN': 'D1RN1KE1KL1KN1CK1',
    'SDFFRS_X2_Q': 'D1RN1KE1KL1KN1CK1',
    'SDFFRS_X2_QN': 'D1RN1KE1KL1KN1CK1',
    'SDFFR_X1_Q': 'D1RN1KE1KL1CK1',
    'SDFFR_X1_QN': 'D1RN1KE1KL1CK1',
    'SDFFR_X2_Q': 'D1RN1KE1KL1CK1',
    'SDFFR_X2_QN': 'D1RN1KE1KL1CK1',
    'SDFFS_X1_Q': 'D1KE1KL1KN1CK1',
    'SDFFS_X1_QN': 'D1KE1KL1KN1CK1',
    'SDFFS_X2_Q': 'D1KE1KL1KN1CK1',
    'SDFFS_X2_QN': 'D1KE1KL1KN1CK1',
    'SDFF_X1_Q': 'D1KE1KL1CK1',
    'SDFF_X1_QN': 'D1KE1KL1CK1',
    'SDFF_X2_Q': 'D1KE1KL1CK1',
    'SDFF_X2_QN': 'D1KE1KL1CK1',
    'TBUF_X1_Z': 'A1EN1',
    'TBUF_X2_Z': 'A1EN1',
    'TBUF_X4_Z': 'A1EN1',
    'TBUF_X8_Z': 'A1EN1',
...
def DFFRS_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFRS_X1_Q gate.

    Args:
        inputs: { 'D', 'RN', 'KN', 'CK','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DFFRS_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFRS_X1_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFRS_X1_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'DFFRS_X1_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFRS_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFRS_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DFFRS_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFRS_X2_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFRS_X2_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'DFFRS_X2_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFR_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFR_X1_Q gate.

    Args:
        inputs: { 'D', 'RN', 'CK','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DFFR_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFR_X1_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFR_X1_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'DFFR_X1_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFR_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFR_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DFFR_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFR_X2_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFR_X2_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'DFFR_X2_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFS_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFS_X1_Q gate.

    Args:
        inputs: { 'D', 'KN', 'CK','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DFFS_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFS_X1_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFS_X1_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'DFFS_X1_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFS_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFS_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DFFS_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFFS_X2_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFFS_X2_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'DFFS_X2_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFF_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFF_X1_Q gate.

    Args:
        inputs: { 'D', 'CK','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DFF_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFF_X1_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFF_X1_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'DFF_X1_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFF_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFF_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DFF_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DFF_X2_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DFF_X2_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'DFF_X2_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DLH_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DLH_X1_Q gate.

    Args:
        inputs: { 'D', 'G','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DLH_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DLH_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DLH_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DLH_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DLL_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DLL_X1_Q gate.

    Args:
        inputs: { 'D', 'GN','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DLL_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def DLL_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' DLL_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'DLL_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))
...
def SDFFRS_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFRS_X1_Q gate.

    Args:
        inputs: { 'D', 'RN', 'KE', 'KL', 'KN', 'CK','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'SDFFRS_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFRS_X1_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFRS_X1_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'SDFFRS_X1_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFRS_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFRS_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'SDFFRS_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFRS_X2_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFRS_X2_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'SDFFRS_X2_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFR_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFR_X1_Q gate.

    Args:
        inputs: { 'D', 'RN', 'KE', 'KL', 'CK','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'SDFFR_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFR_X1_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFR_X1_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'SDFFR_X1_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFR_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFR_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'SDFFR_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFR_X2_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFR_X2_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'SDFFR_X2_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFS_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFS_X1_Q gate.

    Args:
        inputs: { 'D', 'KE', 'KL', 'KN', 'CK','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'SDFFS_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFS_X1_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFS_X1_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'SDFFS_X1_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFS_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFS_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'SDFFS_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFFS_X2_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFFS_X2_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'SDFFS_X2_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFF_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFF_X1_Q gate.

    Args:
        inputs: { 'D', 'KE', 'KL', 'CK','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'SDFF_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFF_X1_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFF_X1_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'SDFF_X1_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFF_X2_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFF_X2_Q gate.
    ...
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'SDFF_X2_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))


def SDFF_X2_QN(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' SDFF_X2_QN gate.
    ...
    Returns:
        QN = IQN
    '''
    p = validate_inputs(inputs, graph, 'SDFF_X2_QN')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))
...
def TLAT_X1_Q(inputs: dict, graph: nx.DiGraph) -> Symbol:
    ''' TLAT_X1_Q gate.

    Args:
        inputs: { 'D', 'G', 'OE','node_name' }
        graph: The networkx graph of the circuit.
    Returns:
        Q = IQ
    '''
    p = validate_inputs(inputs, graph, 'TLAT_X1_Q')
    return ((Lp['node_name'] | ~p['node_name']) &
            (p['node_name'] | ~Lp['node_name']))
...
cell_mapping = {
    ...
    'DFFRS_X1_Q': DFFRS_X1_Q,
    'DFFRS_X1_QN': DFFRS_X1_QN,
    'DFFRS_X2_Q': DFFRS_X2_Q,
    'DFFRS_X2_QN': DFFRS_X2_QN,
    'DFFR_X1_Q': DFFR_X1_Q,
    'DFFR_X1_QN': DFFR_X1_QN,
    'DFFR_X2_Q': DFFR_X2_Q,
    'DFFR_X2_QN': DFFR_X2_QN,
    'DFFS_X1_Q': DFFS_X1_Q,
    'DFFS_X1_QN': DFFS_X1_QN,
    'DFFS_X2_Q': DFFS_X2_Q,
    'DFFS_X2_QN': DFFS_X2_QN,
    'DFF_X1_Q': DFF_X1_Q,
    'DFF_X1_QN': DFF_X1_QN,
    'DFF_X2_Q': DFF_X2_Q,
    'DFF_X2_QN': DFF_X2_QN,
    ...
    'OR4_X2_ZN': OR4_X2_ZN,
    'OR4_X4_ZN': OR4_X4_ZN,
    'SDFFRS_X1_Q': SDFFRS_X1_Q,
    'SDFFRS_X1_QN': SDFFRS_X1_QN,
    'SDFFRS_X2_Q': SDFFRS_X2_Q,
    'SDFFRS_X2_QN': SDFFRS_X2_QN,
    'SDFFR_X1_Q': SDFFR_X1_Q,
    'SDFFR_X1_QN': SDFFR_X1_QN,
    'SDFFR_X2_Q': SDFFR_X2_Q,
    'SDFFR_X2_QN': SDFFR_X2_QN,
    'SDFFS_X1_Q': SDFFS_X1_Q,
    'SDFFS_X1_QN': SDFFS_X1_QN,
    'SDFFS_X2_Q': SDFFS_X2_Q,
    'SDFFS_X2_QN': SDFFS_X2_QN,
    'SDFF_X1_Q': SDFF_X1_Q,
    'SDFF_X1_QN': SDFF_X1_QN,
    'SDFF_X2_Q': SDFF_X2_Q,
    'SDFF_X2_QN': SDFF_X2_QN,
    'TBUF_X1_Z': TBUF_X1_Z,
    'TBUF_X2_Z': TBUF_X2_Z,
    'TBUF_X4_Z': TBUF_X4_Z,
    'TBUF_X8_Z': TBUF_X8_Z,
